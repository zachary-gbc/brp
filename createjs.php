<?php
  if(isset($_GET['buildfile']))
  {
    ...
    while($row = mysqli_fetch_array($rs))
    {
      ...
      $content.=("<p style='margin:15px;font-family:Source Sans Pro'><a target='_blank' href='https://www.biblegateway.com/passage/?search=" . str_replace(" ","%20",$row['RP_Verses']) . "&version=" . $row['RP_Version'] . "'>" . $row['RP_Verses'] . "</a></p>\n");
  ...
  else
  {
    ...
    echo("<h3 style='margin: 3px 0px 0px 5px'>Download Javascript File</h3><br>");
